<div class="filter-col col-lg-4 col-md-4 clearfix ">
    ...
    <div class="row">
        ...
        <div class="form-group row fit-screen">
            ...
            <ui-select multiple ng-model="filters.selectedBrands " theme="select2" class="col-sm-8 col-xs-9">
        ...
        <div class="form-group row fit-screen">
            ...
            <ui-select multiple ng-model="filters.selectedTypes" theme="select2" class="col-sm-8 col-xs-9">
        ...
        <div class="form-group row">
            <div class="range-div form-control-inline col-sm-11 col-xs-12" />
                <input x-year-slider type="text" ng-model="yearslider" />
            </div>
        </div>
        <div class="form-group row">
            <div class="range-div form-control-inline col-sm-11  col-xs-12">
                <input x-mileage-slider ng-model="mileageslider" filters="filters" type="text" />
            </div>
        </div>
        <div class="form-group row">
            <div class="range-div form-control-inline col-sm-11 col-xs-12">
                <input x-price-slider type="text" ng-model="priceslider"/>
            </div>
        </div>
