<div class="filter-col col-lg-4 col-md-4 clearfix ">
    ...
    <div class="row">
        ...
        <!--Model Filter End-->
        <div class="row">
            {{--<button ng-click="toggleModal()" class="btn btn-large cd-popup-trigger col-lg-5 hidden-md hidden-sm hidden-xs notify-lg notify-btn" data-toggle="modal" data-target="#notify-modal"><i class="icon-white fa fa-phone "></i> Notify Me--}}
            {{--</button>--}}

            <button ng-click="toggleModal()" class="btn btn-large cd-popup-trigger col-lg-5 hidden-md hidden-sm hidden-xs notify-lg notify-btn"  ><i class="icon-white fa fa-phone "></i> Notify Me
            </button>
            ...
            <button type="submit" class="btn btn-info btn-large col-lg-6 hidden-md hidden-sm hidden-xs filter-btn"><i
                        class="icon-white fa fa-sort-by-attributes" id="submit" name="submit" ng-click="initCars()"></i> Yalla Filter!
            </button>

            <!--Btn Sm Layout-->
            <button class="btn btn-info btn-large col-xs-12 col-sm-11 hidden-lg hidden-xl filter-btn"><i
                        class="icon-white fa fa-sort-by-attributes"></i> Yalla Filter!
            </button>
