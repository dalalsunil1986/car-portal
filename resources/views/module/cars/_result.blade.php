        ...
        <div class="col-md-12 clearfix">
            ...
            <div class="row sort-row">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu"  ng-model="sortorder"  role="menu" aria-labelledby="dropdownMenu1">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" value="+created_at">Year: New to Old</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" value="-year">Year: Old to new</a></li>
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" selected value="-created_at">Submition: New to Old</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" selected value="+created_at">Submition: Old to New</a></li>
            ...
            <div class="result-entry">
                ...
                <div ng-switch on="loading">
                    {{--<div ng-if="!hasRecord"><h1>no more results</h1></div>--}}
                    <div  id="loading" ng-switch-when="true">  {!! HTML::image('assets/img/icons/loader.gif') !!}
                    </div>
                </div>
            </div>
        </div>
