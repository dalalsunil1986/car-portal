...
{{ HTML::style('site/css/pop-up.css') }}
{{ HTML::style('site/css/bootstrap-editable.css') }}



{{ HTML::style('site/css/style-profile.css') }}
{{ HTML::style('site/css/layout-profile-page.css') }}
...
@section('scripts')
@parent
{{ HTML::script('site/js/pop-up.js') }}
{{ HTML::script('site/js/bootstrap-editable.min.js') }}
{{ HTML::script('site/js/modernizr.js') }}
{{ HTML::script('site/js/wow.min.js') }}
<script>
    ...
    <div class="tab-content wow fadeInDown">
            ...
            <div class="row account-row">
                    ...
                    <div class="flip">
                        <div class="card">
                            ...
                            <div class="face back">
                                ...
                                <div class="back-profile profile-image-setting"><span class="back-text">Back</span>
                ...
                <div class="col-xs-7 basic-info">
                    <div class="row">
                        ...
                        <div class="col-xs-12">example@gmail.com<span class="glyphicon glyphicon-pencil"></span></div>
                        <div class="col-xs-12">Password<span class="glyphicon glyphicon-pencil"></span></div>
                        <div class="row">
                            <div class="col-md-12">
                                <h2>Optional</h2>

                                <div class="col-xs-12">Manage CV<span class="glyphicon glyphicon-pencil"></span></div>
                                <div class="col-xs-12">Account<span class="glyphicon glyphicon-pencil"></span></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-pane" id="posts">
            ...
            <div class="row item-row post-item">
                <div class="col-md-8 column title-color"><img class="post-image" src="../img/custom/car-thumb.jpg">
        ...
        <div class="tab-pane" id="favorites">
            <div class="tab-pane" id="posts">
                ...
                <div class="row item-row">
                    <div class="col-xs-8 column title-color"><img class="post-image" src="../img/custom/car-thumb.jpg">
                        ...
                        <div class="row clearfix notify-pannel">
                            ...
                            <div class="col-xs-6 column">
                                <div class="row clearfix ntf-row">
                                    ...
                                    <div class="col-md-9 column"><span class="ntf-input">Japanese, American</span></div>
                                </div>
                                <div class="row clearfix ntf-row">
                                ...
                                <div class="row clearfix ntf-row">
                                    ...
                                    <div class="col-md-9 column"><span class="ntf-input">Unspecified</span></div>
                                </div>
                                <div class="row clearfix ntf-row">
                            ...
                            <div class="col-xs-6 column">
                                <div class="row clearfix ntf-row">
                                    ...
                                    <div class="col-md-9 column"><span class="ntf-input">2008 - 20013</span></div>
                                </div>
                                <div class="row clearfix ntf-row">
                                    <div class="col-md-3 column"><span class="ntf-feild">Milage:</span></div>
                                    <div class="col-md-9 column"><span class="ntf-input">50,000 - 80,000</span></div>
                                </div>
                                <div class="row clearfix ntf-row">
                                    <div class="col-md-3 column"><span class="ntf-feild">Price:</span></div>
                                    <div class="col-md-9 column"><span class="ntf-input">4,000KD - 6,000 KD</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
