            ...
            $cars = $this->carRepository->model->with(['thumbnail', 'favorited'])
                ...
                ->where(function ($query) use (
                    ...
                    if ($getModels) {
                        ...
                        $query->whereHas('model', function ($query) use ($getBrands, $getTypes) {
                        ...
                        $query->whereHas('model', function ($query) use ($getMakes, $getTypes) {
                            $query->whereHas('brand', function ($query) use ($getMakes, $getTypes) {
